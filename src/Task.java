...
public class Task extends taskURL {
	...
	public void befor() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/a[1]/div[1]/div[2]")).click(); // بسكر الاعلان الاول
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
		driver.manage().window().maximize();// هون عملت تكبير للشاشة عشان اميز متى الغي الاعلان التاني
		driver.findElement(By.xpath("/html/body/a[2]/section/div[1]/article[1]/button")).click();// بنسكر اعلان 2
